...
- Also supports optional `Priority locations` in the XLSX. Any row whose `Current Location` matches a listed priority location is included even when the container tag is not one of the tracked QA hold tags.
